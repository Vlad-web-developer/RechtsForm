...
function App() {
  ...
  const handleDownload = () => {
    ...
    console.log("Generating PDF with files:", uploadedFiles); 
    generateAndDownloadPDF(formData, uploadedFiles);
        ...
        <div className='layout-wrapper'>
          ...
          <AnimatePresence mode='wait'>
            ...
            >
              ...
              {step === 6 && <SectionF data={formData.sectionF} onChange={(f, v) => updateData('sectionF', f, v)} onBack={() => setStep(5)} onNext={() => setStep(7)} hasPartner={formData.sectionE.hasPartner} />}
              ...
              {step === 13 && (
                <div className='section-card finish-card'>
                  ...
                  <p style={{fontSize: '0.9rem', color: 'var(--text-secondary)'}}>
                    Ihre Daten wurden aus dem Browser-Speicher gelöscht.<br/>
                    Bitte unterschreiben Sie das Formular und fügen Sie Ort/Datum handschriftlich hinzu.
                  </p>
                  <div className='button-group' style={{marginTop: '25px'}}>
                    <button className='btn-secondary-action' onClick={handleDownload}>
                        PDF erneut laden
                    </button>
